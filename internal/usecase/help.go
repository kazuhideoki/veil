...
Commands:
  ...
  update    Commit a materialized 1Password document target back to 1Password (--overwrite-remote)
  ...
  emerge    Materialize registered 1Password document targets into a workspace (--repo, --all)
